  ...
  return (
    <Pag size="sm">
      { index-1 > 0 ? 
        (
          <>
          <Pag.First onClick={() => {activeItem(1); pageChange(1)}} />
          <Pag.Prev onClick={() => {activeItem(index-1); pageChange(index-1)}} />
          </>
        ) : 
        (
          <>
      ...
      { 
        ...
        (
          <>
            <Pag.Next onClick={() => {activeItem(index+1); pageChange(index+1)}} />
            <Pag.Last onClick={() => {activeItem(nro); pageChange(nro)}} />
          </>
        ) : 
        (
          <>
